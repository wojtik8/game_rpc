...
public class RemoteException extends TException implements org.apache.thrift.TBase<RemoteException, RemoteException._Fields>, java.io.Serializable, Cloneable, Comparable<RemoteException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoteException");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoteExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RemoteExceptionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoteException.class, metaDataMap);
  }
   ...
   */
  public RemoteException(RemoteException other) {
  ...
  public RemoteException deepCopy() {
  ...
  public RemoteException setWhat(int what) {
    this.what = what;
    setWhatIsSet(true);
    return this;
  }
  ...
  public RemoteException setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoteException)
      return this.equals((RemoteException)that);
    return false;
  }

  public boolean equals(RemoteException that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RemoteException other) {
  ...
  private static class RemoteExceptionStandardSchemeFactory implements SchemeFactory {
    public RemoteExceptionStandardScheme getScheme() {
      return new RemoteExceptionStandardScheme();
    }
  }

  private static class RemoteExceptionStandardScheme extends StandardScheme<RemoteException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoteException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoteException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RemoteExceptionTupleSchemeFactory implements SchemeFactory {
    public RemoteExceptionTupleScheme getScheme() {
      return new RemoteExceptionTupleScheme();
    }
  }

  private static class RemoteExceptionTupleScheme extends TupleScheme<RemoteException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoteException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoteException struct) throws org.apache.thrift.TException {
